...
/**
 * Legal Disclaimer Modal - Required before using TikTok downloader
 * 
 * This component MUST be shown on first visit and user must accept
 * to proceed with downloading videos.
 */
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>
                    This service only supports downloading public TikTok videos. 
                    Private, age-restricted, or geo-blocked content cannot be downloaded.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium mb-1">TikTok Terms of Service</p>
                  <p>
                    You must comply with TikTok's Terms of Service. 
                    This tool is for personal use only and should not be used to violate TikTok's policies.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium mb-1">No Watermark Removal</p>
                  <p>
                    Videos are downloaded without watermarks using yt-dlp. 
                    This is a technical feature, not a way to bypass TikTok's terms.
                  </p>
                </div>
              </div>
            </div>
          ...
          <details className="border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <div className="px-4 pb-4 pt-2 text-xs text-gray-600 dark:text-gray-400 space-y-2">
              <p>
                ...
                accesses TikTok videos through public APIs. We do not scrape HTML or use unofficial APIs.
              </p>
              <p>
                <strong>No watermark:</strong> yt-dlp can download the original video file without 
                TikTok's watermark. This is a feature of the tool, not a workaround.
              </p>
              <p>
